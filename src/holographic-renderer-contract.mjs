 ...
 */
export function compileHolographicRenderPacket({ scene, presentation } = {}) {
...
export function validateHolographicRenderPacket(packet) {
  try {
    ...
    if (value.safety?.authoritative !== false) return false;
    if (value.safety?.actuatesHardware !== false) return false;
    if (value.safety?.advisoryOnly !== true) return false;
